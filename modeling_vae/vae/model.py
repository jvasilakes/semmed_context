...
def build_vae(params, vocab_size, emb_matrix, label_dims, device,
    ...
    """
    if params.Model.bow_encoder.value is True:
        encoder = BOWEncoder(vocab_size, params.Model.embedding_dim.value,
                             emb_matrix=emb_matrix,
                             dropout_rate=params.Model.encoder_dropout.value)
    else:
        encoder = VariationalEncoder(
            vocab_size, params.Model.embedding_dim.value,
            params.Model.hidden_dim.value,
            params.Model.num_rnn_layers.value,
            dropout_rate=params.Model.encoder_dropout.value,
            emb_matrix=emb_matrix,
            bidirectional=params.Model.bidirectional_encoder.value)
    ...
    decoder = VariationalDecoder(
        ...
        params.Model.hidden_dim.value,
        params.Model.num_rnn_layers.value,
        dropout_rate=params.Model.decoder_dropout.value,
        emb_matrix=emb_matrix)
